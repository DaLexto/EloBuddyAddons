    ...
    internal static class MenuManager
    {
        ...
        public static Menu AddSubbMenu(string sMenuName, Menu mMenu = null)
        {
            if (mMenu != null)
            {
                ...
                Menus[mMenu.DisplayName][sMenuName].Add(mMenu.AddSubMenu(sMenuName, sMenuName),
            ...
            // Add the submenu to the Menus list and init the list of ids and values
            Menus[CurrentMainMenu.DisplayName][sMenuName].Add(CurrentMainMenu.AddSubMenu(sMenuName, sMenuName),
                new Dictionary<string, Values>());
        ...
        {
            if (Menus[menu.Parent.DisplayName][menu.DisplayName][menu].Keys.All(it => it != identifier))
            {
        ...
        public static void NewCheckbox(this Menu menu, string identifier, string displayName, bool defaultValue = true,
        ...
        public static void NewSlider(this Menu menu, string identifier, string displayName, int defaultValue,
            int minValue, int maxValue, bool separatorBefore = false)
        {
            if (separatorBefore)
                menu.AddSeparator();
        ...
        public static void NewKeybind(this Menu menu, string identifier, string displayName, bool defaultValue,
            KeyBind.BindTypes bindType, char key, bool separatorBefore = false)
        {
            if (separatorBefore)
                menu.AddSeparator();
